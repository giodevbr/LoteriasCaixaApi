...
{
    public class UltimosResultadosLotecaDto
    {
        [JsonProperty("resultadoJogos")]
        public List<UltimosResultadosLotecaResultadoJogoDto> ResultadoJogos { get; set; }
